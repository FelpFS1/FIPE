            ...
            <>
                ...
                <motion.main 
                 ...
                 >
                    ...
                    <h2 className="font-semibold text-xl sm:text-2xl lg:text-3xl">Está procurando um lugar para consultar a <span className="text-red-600">FIPE</span> do seu veículo?</h2>
                    </section>
                    <section className="grid grid-cols-2 gap-5 p-3 mt- m-auto">
                        <Card text={"Custo zero"} svg={money}/>
                        <Card text={"Fipe atualizada"} svg={actual}/>
                    </section>
                    <div className="w-scren my-7 text-center">
                        <h2 className="text-3xl font-bold">Encontrou o lugar certo!</h2>
                    </div>
